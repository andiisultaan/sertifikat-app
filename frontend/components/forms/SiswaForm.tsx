  ...
  useEffect(() => {
    if (defaultValues) {
      reset({
        ...
        tanggal_lahir: defaultValues.tanggal_lahir ? defaultValues.tanggal_lahir.toString().slice(0, 10) : "",
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="space-y-1">
          ...
          <div className="flex gap-4 pt-1">
            <label className="flex items-center gap-2 cursor-pointer text-sm">
              <input type="radio" value="L" {...register("jenis_kelamin")} className="accent-primary" />
              Laki-laki
            </label>
            <label className="flex items-center gap-2 cursor-pointer text-sm">
              <input type="radio" value="P" {...register("jenis_kelamin")} className="accent-primary" />
              Perempuan
            </label>
          </div>
        ...
        <div className="space-y-1">
          ...
          <Input id="tahun_masuk" type="number" {...register("tahun_masuk", { valueAsNumber: true })} placeholder="2023" />
          {errors.tahun_masuk && <p className="text-xs text-red-500">{errors.tahun_masuk.message}</p>}
        </div>
      </div>
